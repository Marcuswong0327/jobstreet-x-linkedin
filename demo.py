...
def match_companies_enhanced(jobstreet_companies, linkedin_companies, threshold=75):
    """
    Enhanced company matching using both semantic similarity and fuzzy matching
    """
    matches = {}
    
    # First try semantic matching with a slightly lower threshold
    ...
    # For unmatched companies, try fuzzy matching with normalized names
